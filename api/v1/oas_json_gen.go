...
func (s *AddProjectRequest) encodeFields(e *jx.Encoder) {
	...
	{
		if s.IsFundedBy.Set {
			e.FieldStart("is_funded_by")
			s.IsFundedBy.Encode(e)
		}
	}
	{
		if s.HasAcronym.Set {
			e.FieldStart("has_acronym")
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "is_funded_by":
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"is_funded_by\"")
			}
		case "has_acronym":
			if err := func() error {
				s.HasAcronym.Reset()
				...
				return errors.Wrap(err, "decode field \"has_acronym\"")
			}
		case "name":
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "is_awarded_by":
			if err := func() error {
				...
				return errors.Wrap(err, "decode field \"is_awarded_by\"")
			}
		default:
			return d.Skip()
		}
...
var jsonFieldsNameOfGetProjectResponse = [10]string{
	0: "id",
	1: "type",
	2: "identifier",
	3: "has_acronym",
